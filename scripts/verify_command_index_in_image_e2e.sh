...
echo "$DRY_OUTPUT" | grep -q "planned_commands=senior-zero-preflight-report,senior-zero-update-check,senior-zero-runtime-profile,senior-zero-network-check,senior-zero-storage-check,senior-zero-self-check"
